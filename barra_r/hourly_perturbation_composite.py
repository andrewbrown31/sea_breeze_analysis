...
if __name__ == "__main__":
    ...
    output_path = "/g/data/ng72/ab4502/hourly_composites/barra_r/barra_r_hourly_"+\
        u_var+"_"+v_var+"_"+\
    ...
    output_path = "/g/data/ng72/ab4502/hourly_composites/barra_r/barra_r_hourly_perturbation_"+\
        u_var+"_"+v_var+"_"+\
        pd.to_datetime(t1).strftime("%Y%m%d%H%M")+"_"+\
        (pd.to_datetime(t2).strftime("%Y%m%d%H%M"))
    if os.path.isdir(os.path.dirname(output_path)):
