...
#PBS -l ncpus=48
#PBS -l jobfs=32gb
#PBS -o /home/548/ab4502/working/ExtremeWind/jobs/messages/barra_c_sb_composite_southern.o 
#PBS -e /home/548/ab4502/working/ExtremeWind/jobs/messages/barra_c_sb_composite_southern.e
...
while [[ "$current_date" < "$end_date" ]]; do
    ...
    python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite.py "$start_time" "$end_time" --region southern --lat_start "-45" --lat_end "-30" --lon_start 135 --lon_end 155
...
python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite_sum.py --region southern