...
while [[ "$current_date" < "$end_date" ]]; do
    ...
    python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite.py "$start_time" "$end_time" --region gipps --lat_start "-45" --lat_end "-30" --lon_start 135 --lon_end 155
...
python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite_sum.py --region gipps