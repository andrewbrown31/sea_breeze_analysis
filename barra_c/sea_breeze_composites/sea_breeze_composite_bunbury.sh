...
while [[ "$current_date" < "$end_date" ]]; do
    ...
    python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite.py "$start_time" "$end_time" --region bunbury --lat_start "-42" --lat_end "-27" --lon_start 108 --lon_end 125
...
python /home/548/ab4502/working/sea_breeze_analysis/barra_c/sea_breeze_composites/sea_breeze_composite_sum.py --region bunbury