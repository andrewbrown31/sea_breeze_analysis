...
def preprocess_aest(ds):
    ...
    ds = ds.sel(time=(ds.time.dt.hour >= 10) & (ds.time.dt.hour <= 21))
    ds.attrs["time_zone"] = "AEST"
    ds.attrs["local_time_restriction"] = "1000_2100"
...
if __name__ == "__main__":
    ...
    ds_awst.chunk({"time":101}).to_zarr(f"{base_path}/{model}/filters/daily_filtered_{name}_{variable}_awst_{t1}_{t2}.zarr",mode="w")
